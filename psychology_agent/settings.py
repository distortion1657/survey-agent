"""
Django settings for psychology_agent project.
...
SECRET_KEY = 'django-insecure-p1zv31&a9#f@)j@2_35()-ebqgbu)e=8&q&8s3h*@fjpp-z(y&'
...
WSGI_APPLICATION = 'psychology_agent.wsgi.application'
